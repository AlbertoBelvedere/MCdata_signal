...
// Thu Jun  3 18:22:08 2021 by ROOT version 6.14/02
// from TTree fitter_tree/reduced tree for T&P
// found on file: Formatted_TnP_March21_Run2018ALL__probeLowPt.root
//////////////////////////////////////////////////////////
...
#ifdef ntuplaSig_cxx
ntuplaSig::ntuplaSig(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Formatted_TnP_March21_Run2018ALL__probeLowPt.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Formatted_TnP_March21_Run2018ALL__probeLowPt.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Formatted_TnP_March21_Run2018ALL__probeLowPt.root:/tnpAna");
...
Int_t ntuplaSig::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ntuplaSig::LoadTree(Long64_t entry)
{
...
void ntuplaSig::Init(TTree *tree)
{
...
void ntuplaSig::Show(Long64_t entry)
{
...
Int_t ntuplaSig::Cut(Long64_t entry)
{
